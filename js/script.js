...
document.addEventListener('DOMContentLoaded', function() {
    try {
        ...
        let isOpenBox2 = false; // Variable to track the state for box2
        let isOpenBox3 = false; // Variable to track the state for box3

        if (openButtonBox2 && openButtonBox3 && imageBox1 && imageBox4) {
            // Function to toggle image and button text for box2
            function toggleImageAndButtonTextBox2() {
                if (isOpenBox2) {
                    imageBox1.src = './images/ex-close.jpg'; // Change the image source for box2
                    openButtonBox2.textContent = 'OPEN'; // Change button text to OPEN for box2
                  } else {
                    imageBox1.src = './images/ex-open.jpg'; // Change the image source for box2
                    openButtonBox2.textContent = 'CLOSE'; // Change button text to CLOSE for box2
                  }
                  isOpenBox2 = !isOpenBox2; // Toggle the state for box2
                // Toggle image and button text logic for box2
            }

            // Function to toggle image and button text for box3
            function toggleImageAndButtonTextBox3() {
                if (isOpenBox3) {
                    imageBox4.src = './images/ex-on.jpg'; // Change the image source for box4
                    openButtonBox3.textContent = 'OFF'; // Change button text to OPEN for box3
                  } else {
                    imageBox4.src = './images/ex-off.jpg'; // Change the image source for box4
                    openButtonBox3.textContent = 'ON'; // Change button text to CLOSE for box3
                  }
                  isOpenBox3 = !isOpenBox3; // Toggle the state for box3
                // Toggle image and button text logic for box3
            }

            // Adding click event listener to the OPEN button for box2
            openButtonBox2.addEventListener('click', toggleImageAndButtonTextBox2);

            // Adding click event listener to the OPEN button for box3
...
function countNumbers() {
    const txt2Values = document.querySelectorAll('.counting-text');
  ...
  // 페이지 로드 후 숫자 카운팅 함수 호출
  window.addEventListener('DOMContentLoaded', countNumbers);
